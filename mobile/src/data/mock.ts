...
export const MOCK_COOKS: MockCook[] = [
  {
    ...
    menu: [
      { id: 'jollof', title: 'Smoky party jollof, grilled croaker', note: 'Saturdays only', price: 7500, slotsLeft: 4, totalSlots: 12, tint: '#FF6B35', photoTint: '#FF6B35', photoLabel: 'Jollof', description: "West African firewood style." },
