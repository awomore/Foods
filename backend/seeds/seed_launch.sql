...
INSERT INTO cook_profiles (
  ...
  (
    ...
    'https://res.cloudinary.com/dbaqilapv/image/upload/v1/seeds/ada_avatar.jpg',
    ARRAY['https://res.cloudinary.com/dbaqilapv/image/upload/v1/seeds/ada_kitchen.jpg'],
    4.8, 127, 94,
    true, true, true,
    ARRAY['home_cook'], 'NGN',
    false, false, 1240
  ...
  (
    ...
    'https://res.cloudinary.com/dbaqilapv/image/upload/v1/seeds/emeka_avatar.jpg',
    ARRAY['https://res.cloudinary.com/dbaqilapv/image/upload/v1/seeds/emeka_kitchen.jpg'],
    4.7, 89, 91,
    true, true, true,
  ...
  (
    ...
    'https://res.cloudinary.com/dbaqilapv/image/upload/v1/seeds/fatima_avatar.jpg',
    ARRAY['https://res.cloudinary.com/dbaqilapv/image/upload/v1/seeds/fatima_kitchen.jpg'],
    4.9, 203, 97,
    true, true, true,
  ...
  (
    ...
    'https://res.cloudinary.com/dbaqilapv/image/upload/v1/seeds/tunde_avatar.jpg',
    ARRAY['https://res.cloudinary.com/dbaqilapv/image/upload/v1/seeds/tunde_kitchen.jpg'],
    5.0, 44, 99,
    true, true, true,
    ARRAY['chef'], 'NGN',
    true, true, 560
  ...
  (
    ...
    'https://res.cloudinary.com/dbaqilapv/image/upload/v1/seeds/ngozi_avatar.jpg',
    ARRAY['https://res.cloudinary.com/dbaqilapv/image/upload/v1/seeds/ngozi_kitchen.jpg'],
    4.6, 156, 89,
    true, true, true,
    ARRAY['home_cook'], 'NGN',
    false, false, 2200
  ...
  (
    ...
    'https://res.cloudinary.com/dbaqilapv/image/upload/v1/seeds/amaka_avatar.jpg',
    ARRAY['https://res.cloudinary.com/dbaqilapv/image/upload/v1/seeds/amaka_kitchen.jpg'],
    4.8, 311, 95,
    true, true, true,
  ...
  (
    ...
    'https://res.cloudinary.com/dbaqilapv/image/upload/v1/seeds/chidi_avatar.jpg',
    ARRAY['https://res.cloudinary.com/dbaqilapv/image/upload/v1/seeds/chidi_kitchen.jpg'],
    4.7, 67, 92,
    true, true, true,
    ARRAY['caterer'], 'NGN',
    false, true, 710
  ...
  (
    ...
    'https://res.cloudinary.com/dbaqilapv/image/upload/v1/seeds/halima_avatar.jpg',
    ARRAY['https://res.cloudinary.com/dbaqilapv/image/upload/v1/seeds/halima_kitchen.jpg'],
    4.5, 78, 87,
    true, true, true,
    ARRAY['home_cook'], 'NGN',
    false, false, 640
  ...
  (
    ...
    'https://res.cloudinary.com/dbaqilapv/image/upload/v1/seeds/bola_avatar.jpg',
    ARRAY['https://res.cloudinary.com/dbaqilapv/image/upload/v1/seeds/bola_kitchen.jpg'],
    4.9, 95, 96,
    true, true, true,
  ...
  (
    ...
    'https://res.cloudinary.com/dbaqilapv/image/upload/v1/seeds/chisom_avatar.jpg',
    ARRAY['https://res.cloudinary.com/dbaqilapv/image/upload/v1/seeds/chisom_kitchen.jpg'],
    4.7, 132, 90,
    true, true, true,
    ARRAY['home_cook'], 'NGN',
    false, false, 1150
  ...
  (
    ...
    'https://res.cloudinary.com/dbaqilapv/image/upload/v1/seeds/rukayat_avatar.jpg',
    ARRAY['https://res.cloudinary.com/dbaqilapv/image/upload/v1/seeds/rukayat_kitchen.jpg'],
    4.8, 189, 93,
    true, true, true,
    ARRAY['home_cook'], 'NGN',
    false, false, 2800
  ...
  (
    ...
    'https://res.cloudinary.com/dbaqilapv/image/upload/v1/seeds/ifeanyi_avatar.jpg',
    ARRAY['https://res.cloudinary.com/dbaqilapv/image/upload/v1/seeds/ifeanyi_kitchen.jpg'],
    4.9, 56, 98,
    true, true, true,
...
INSERT INTO menu_items (
  ...
  ('aaaaaaaa-0000-0000-0000-000000000001', 'cccccccc-0000-0000-0000-000000000001',
   ...
   4500, 'NGN', ARRAY['https://res.cloudinary.com/dbaqilapv/image/upload/v1/seeds/ofe_onugbu.jpg'],
  ...
  ('aaaaaaaa-0000-0000-0000-000000000002', 'cccccccc-0000-0000-0000-000000000001',
   ...
   4200, 'NGN', ARRAY['https://res.cloudinary.com/dbaqilapv/image/upload/v1/seeds/egusi.jpg'],
  ...
  ('aaaaaaaa-0000-0000-0000-000000000003', 'cccccccc-0000-0000-0000-000000000001',
   ...
   5000, 'NGN', ARRAY['https://res.cloudinary.com/dbaqilapv/image/upload/v1/seeds/banga.jpg'],
  ...
  ('aaaaaaaa-0000-0000-0000-000000000004', 'cccccccc-0000-0000-0000-000000000002',
   ...
   3500, 'NGN', ARRAY['https://res.cloudinary.com/dbaqilapv/image/upload/v1/seeds/suya.jpg'],
  ...
  ('aaaaaaaa-0000-0000-0000-000000000005', 'cccccccc-0000-0000-0000-000000000002',
   ...
   4800, 'NGN', ARRAY['https://res.cloudinary.com/dbaqilapv/image/upload/v1/seeds/catfish_pepper.jpg'],
  ...
  ('aaaaaaaa-0000-0000-0000-000000000006', 'cccccccc-0000-0000-0000-000000000003',
   ...
   2500, 'NGN', ARRAY['https://res.cloudinary.com/dbaqilapv/image/upload/v1/seeds/chinchin.jpg'],
  ...
  ('aaaaaaaa-0000-0000-0000-000000000007', 'cccccccc-0000-0000-0000-000000000003',
   ...
   3000, 'NGN', ARRAY['https://res.cloudinary.com/dbaqilapv/image/upload/v1/seeds/cake.jpg'],
  ...
  ('aaaaaaaa-0000-0000-0000-000000000008', 'cccccccc-0000-0000-0000-000000000005',
   ...
   22000, 'NGN', ARRAY['https://res.cloudinary.com/dbaqilapv/image/upload/v1/seeds/mealprep.jpg'],
  ...
  ('aaaaaaaa-0000-0000-0000-000000000009', 'cccccccc-0000-0000-0000-000000000005',
   ...
   3800, 'NGN', ARRAY['https://res.cloudinary.com/dbaqilapv/image/upload/v1/seeds/lowcarb_jollof.jpg'],
  ...
  ('aaaaaaaa-0000-0000-0000-000000000010', 'cccccccc-0000-0000-0000-000000000006',
   ...
   18000, 'NGN', ARRAY['https://res.cloudinary.com/dbaqilapv/image/upload/v1/seeds/small_chops.jpg'],
  ...
  ('aaaaaaaa-0000-0000-0000-000000000011', 'cccccccc-0000-0000-0000-000000000008',
   ...
   3500, 'NGN', ARRAY['https://res.cloudinary.com/dbaqilapv/image/upload/v1/seeds/tuwo.jpg'],
  ...
  ('aaaaaaaa-0000-0000-0000-000000000012', 'cccccccc-0000-0000-0000-000000000008',
   ...
   2800, 'NGN', ARRAY['https://res.cloudinary.com/dbaqilapv/image/upload/v1/seeds/kilishi.jpg'],
  ...
  ('aaaaaaaa-0000-0000-0000-000000000013', 'cccccccc-0000-0000-0000-000000000009',
   ...
   2200, 'NGN', ARRAY['https://res.cloudinary.com/dbaqilapv/image/upload/v1/seeds/zobo.jpg'],
  ...
  ('aaaaaaaa-0000-0000-0000-000000000014', 'cccccccc-0000-0000-0000-000000000011',
   ...
   4000, 'NGN', ARRAY['https://res.cloudinary.com/dbaqilapv/image/upload/v1/seeds/asun.jpg'],
  ...
  ('aaaaaaaa-0000-0000-0000-000000000015', 'cccccccc-0000-0000-0000-000000000011',
   ...
   5500, 'NGN', ARRAY['https://res.cloudinary.com/dbaqilapv/image/upload/v1/seeds/nkwobi.jpg'],
