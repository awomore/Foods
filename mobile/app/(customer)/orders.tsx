...
const styles = StyleSheet.create({
  ...
  trackCtaText: { fontFamily: Fonts.sansMedium, fontSize: 13, color: Colors.spice, flex: 1 },
  ...
  submitBtnText: { fontFamily: Fonts.sansMedium, fontSize: 15, color: Colors.canvas },
