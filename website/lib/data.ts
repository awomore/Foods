...
export const CREATORS: Creator[] = [
  {
    ...
    avatar: '/images/creators/titilayo.webp',
  },
  {
    name: 'Chuka Obi',
    handle: '@chukaeats',
    ...
    avatar: '/images/creators/chuka.webp',
  },
  {
    name: 'Amara Nwosu',
    handle: '@amarabakes',
    ...
    avatar: '/images/creators/amara.webp',
  },
  {
    name: 'Ifeoma Eze',
    handle: '@chefify',
    ...
    avatar: '/images/creators/ifeoma.webp',
  },
  {
    name: 'Bisi Akande',
    handle: '@bisiskitchen',
    ...
    avatar: '/images/creators/bisi.webp',
  },
  {
    name: 'Tomi Lawson',
    handle: '@smalltomi',
    ...
    avatar: '/images/creators/tomi.webp',
  },
];
...
export const TESTIMONIALS: Testimonial[] = [
  ...
  },
  {
    ...
    avatar: '/images/creators/daniel.webp',
  },
  {
    quote:
    ...
    name: 'Samuel Adebayo',
    role: 'Fleet partner · Nigeria',
    avatar: '/images/creators/samuel.webp',
  },
];
...
export const POSTS: Post[] = [
  {
    ...
    body: [
      ...
      'We think that’s backwards. The most talented cooks across Nigeria, Ghana, and Kenya are not interchangeable. They have a hand, a story, a signature. People don’t crave “jollof” in the abstract — they crave Mama Titi’s smoky party jollof, the one with the right amount of char.',
      ...
      'Underneath it runs a delivery network owned by thousands of fleet partners — bicycle and motorbike riders, cooperatives, and community transport groups — who get the technology, brand, and order flow to build real businesses of their own.',
...
export const JOBS: Job[] = [
  { title: 'Senior Product Designer', team: 'Design', location: 'Nigeria / Remote', type: 'Full-time' },
  { title: 'Staff Engineer, Marketplace', team: 'Engineering', location: 'Nigeria / Remote', type: 'Full-time' },
  { title: 'Creator Partnerships Lead', team: 'Growth', location: 'Nigeria', type: 'Full-time' },
  { title: 'Fleet Operations Manager', team: 'Operations', location: 'Nigeria', type: 'Full-time' },
  { title: 'Community Manager', team: 'Community', location: 'Nigeria / Hybrid', type: 'Full-time' },
...
export const PRESS_ITEMS: PressItem[] = [
  ...
  { outlet: 'TechCrunch', title: 'The creator economy comes for food, starting in Nigeria', date: '14/05/2026', href: '#' },
  { outlet: 'Rest of World', title: 'Inside the partner-owned delivery network powering FOODS', date: '30/04/2026', href: '#' },
  { outlet: 'BusinessDay', title: 'How a Nigerian startup is reframing food delivery as creator commerce', date: '12/04/2026', href: '#' },
];
