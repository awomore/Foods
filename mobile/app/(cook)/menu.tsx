...
const styles = StyleSheet.create({
  ...
  addBtnText: { fontFamily: Fonts.sansMedium, fontSize: 13, color: Colors.canvas, fontWeight: '600' },
  ...
  liveText: { fontFamily: Fonts.sansMedium, fontSize: 12, color: Colors.successFg, fontWeight: '600' },
