...
import {
  ...
  Bike, Timer, RotateCcw, Settings, Radio, TrendingUp,
  MapPin, BarChart3, Globe, DollarSign,
} from 'lucide-react';
...
const NAV: Array<{ href: string; label: string; icon: React.ElementType } | 'divider'> = [
  ...
  { href: '/dashboard/riders', label: 'Riders / Fleet', icon: Bike },
  ...
  { href: '/dashboard/zones', label: 'Zones', icon: Globe },
  { href: '/dashboard/fleet-economics', label: 'Fleet Economics', icon: DollarSign },
